...
## Javascript Assignments  [![Build Status](https://travis-ci.org/che6urek/js-assignments.svg?branch=master)](https://travis-ci.org/che6urek/js-assignments)
...
```
* Open https://github.com/che6urek/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
